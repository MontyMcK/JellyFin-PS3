...
void xmb_rsx_draw_osk(void) {
    ...
    if (count == 0 && g_search_buf[0] && xmb_search_in_flight()) {
        // The query is out on its worker thread.  This server takes 2.5-8.4 s
        // to answer a search (HANDOFF.md), and saying "No results" for that
